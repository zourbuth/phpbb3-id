...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_UNAVAILABLE'					=> 'CAPTCHA tidak dapat dipilih karena tidak sesuai dengan persyarataran.',
	...
	'CAPTCHA_SELECT'						=> 'Plugin CAPTCHA yang terinstal',
	'CAPTCHA_SELECT_EXPLAIN'				=> 'Kotak pilihan memegang plugin CAPTCHA yang dikenali halaman. Entri kelabu tidak tersedia sekarang ini dan mengkin membutuhkan konfigurasi yang tepat.',
	'CAPTCHA_CONFIGURE'						=> 'Atur CAPTCHA',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Ubah pengaturan dari CAPTCHA yang terpilih.',
	'CONFIGURE'								=> 'Atur',
	'CAPTCHA_NO_OPTIONS'					=> 'CAPTCHA ini tidak memiliki pilihan konfigarusi.',
    ...
    'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Ijinkan pengguna untuk meminta kode konfirmasi yang baru jika mereka tidak dapat melihat secara jelas kode konfirmasi visual pada saat pendaftaran.',
));
...
$lang = array_merge($lang, array(
	...
	'JAB_PASSWORD_EXPLAIN'		=> '<em><strong>Peringatan:</strong> Kata sandi ini akan disimpan sebagai teks biasa pada database, bisa dilihat siapapun yang bisa mengakses database anda atau siapapun yang bisa melihat halaman konfigurasi ini.</em>',
